...
var mafiaDefines = [
                ...
                rows: [
                    {
                        ...
                        description: {
                            'text': '打网球ddddddd的期望的期望的期望的期望的期望的'
                        },
                        date: {
                            text: '昨天'
                        }
    ...
    // DRSVGLoadingView
    {
        ...
        bottomTextArray: [
            '请确保信息真实无误', '完成电商认证可提高审批通过率', '您提供的信息将被严格加密', '点融网已成功为百万用户提供借款', '信用的积累从现在开始'
        ],
        action: 'start',
        countInfo: {
            from: 0,
    ...
    // MafiaInfiniteScrollView
    {
        ...
        data: [
            {
                url: 'https://forum-img.dianrong.com/data/attachment/portal/201605/18/172651mshw8xhvle5xi8bv.jpg',
                action: {
                    command: 'goto:http://mp.weixin.qq.com/s?__biz=MjM5NjA5NDczMg==&mid=504783141&idx=1&sn=f7b96b8f2bf4ab399dbdb7184bef37f7#rd'
                }
            }, {
                url: 'https://forum-img.dianrong.com/data/attachment/portal/201605/16/142329po6jz0mrgfm2fj0g.jpg',
                action: {
                    command: 'goto:https://mp.weixin.qq.com/s?__biz=MjM5NjA5NDczMg==&mid=2652266762&idx=1&sn=67edd3870dd32eff3f452b8e667dd4f9&key=b28b03434249256bfc7b6fe5d91528d0e5e3bfe3552810e950cdf1361d4c1d257af4d1a97a217b4f17c6869cd6ed408c&ascene=0&uin=MTE0NTM2Nzc0Mg%3D%3D&devicetype=iMac+MacBookAir7%2C2+OSX+OSX+10.11.3+build(15D21)&version=11020201&pass_ticket=15kb334KuBULlrlkhe21CG%2B81TDFg5hO2XFwCm49ymD5HA1wEIczQqXkY6YYOFyv'
                }
            }, {
                url: 'https://forum-img.dianrong.com/data/attachment/portal/201605/13/123142boyhpfp66llolsl6.jpg',
                action: {
                    command: 'goto:https://mp.weixin.qq.com/s?__biz=MjM5NjA5NDczMg==&mid=504782979&idx=1&sn=8416da517b3a8e9bc9c372ae6cff4ecb#rd'
                }
            }
